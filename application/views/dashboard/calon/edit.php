				...
				<div class="col-sm-12">
					<div class="page-title-box">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Calon Edit</li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
                  ...
                  <?php foreach($calon as $c){?>
							<form method="post" action="<?php echo base_url('inipanel/calon_edit_aksi')?>" enctype="multipart/form-data">
								<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>"
									value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                        <input type="hidden" name="id" value="<?=encrypt_url($c->calon_id)."";?>">
								<div class="form-group row">
									<label class="col-sm-3 col-form-label">Nama</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="nama" value="<?= $c->calon_nama;?>"
											required>
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
                              <textarea class="form-control" name="visi" id="editor" required><?= $c->calon_visi;?></textarea>
									</div>
                        ...
                        <div class="form-group row">
									...
									<div class="col-sm-9">
                              <textarea class="form-control" name="misi" id="editor1" required><?= $c->calon_misi;?></textarea>
									</div>
								...
								<div class="form-group row">
                                 ...
                                 foreach($kelas as $k) {?>
                                    <option <?php if($c->calon_kelas == $k->kelas_id){echo "selected='selected'";} ?>
                        ...
                        <div class="form-group row">
                              ...
                              <small class="text-danger">(Format File: JPG/JPEG/PNG)</small>
									...
									<div class="col-sm-9">
                              <input type="file" class="filestyle" id="upload" name="foto" data-buttonname="btn-secondary">
									</div>
									<?php
